...
namespace TinyGarage.Api.Migrations
{
    ...
    [Migration("20240216093410_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TinyGarage.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("TinyGarage.Models.Car", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TinyGarage.Models.CarModel", b =>
                {
                    ...
                    b.Property<Guid>("ModelCollectionId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TinyGarage.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TinyGarage.Models.Car", b =>
                {
                    b.HasOne("TinyGarage.Models.CarModel", "CarModel")
                        .WithMany("Cars")
